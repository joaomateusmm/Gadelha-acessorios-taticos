      ...
      <div className="relative z-20 mx-auto max-w-7xl px-4 md:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="flex flex-col gap-6 lg:col-span-4">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-neutral-400">
              Equipamentos que acompanham sua missão com Resistência, Discrição
              e Performance. Enviamos para todo o Brasil.{" "}
              <a
                className="hover:underline"
                href="https://w.app/gadelhacessoriostaticos"
              >
            ...
            <div className="flex gap-4">
              <Link
                href="https://www.instagram.com/gadelhaacessorios.taticos/"
                className="flex h-9 w-9 items-center justify-center rounded-full border-white/10 bg-white/5 text-neutral-400 transition-all hover:border-[#D00000] hover:bg-[#D00000] hover:text-white"
              >
        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          <div className="text-center text-xs text-neutral-500 md:text-left">
            <p>
              © {currentYear} Gadelha Acessórios Táticos. Todos os direitos
              reservados.
            </p>
          </div>
          <div className="text-center text-xs text-neutral-500 md:text-left">
            <p className="mt-1">
              CNPJ: 37.033.193/0001-97 •{" "}
              <a
                className="hover:underline"
                href="https://www.instagram.com/joaomateusdev/"
              >
                Desenvolvido por João Mateus Dev
              </a>
            </p>
          </div>
        </div>
