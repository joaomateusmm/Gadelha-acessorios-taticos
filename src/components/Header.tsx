...
export function Header() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const bnds = await getAllBrands();
        if (Array.isArray(bnds)) setBrands(bnds);
      } catch (error) {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 flex w-full flex-col transition-all duration-1000 ease-[cubic-bezier(0.76,0,0.24,1)]">
      ...
      <div
        className={cn(
          "backdrop--lg w-full overflow-hidden bg-black/80 transition-all duration-1000 ease-[cubic-bezier(0.76,0,0.24,1)]",
          isHidden
        ...
        <div className="mx-auto flex h-18 max-w-7xl items-center justify-between px-4 py-3 md:px-8">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="start"
                className="backdrop--xl z-[100] w-48 border-white/10 bg-black/80 text-white"
              >
                {isLoadingCategories ? (
                ...
                {isLoadingBrands ? (
                  ...
                  brands.map((b: any, index: number) => (
                    <DropdownMenuItem
                      ...
                      className="cursor-pointer focus:bg-white/10 focus:text-white"
                    >
                      <Link href={b.href || "#"} className="w-full">
                        {b.label}
                      </Link>
                    </DropdownMenuItem>
                  ))
            ...
            <HeaderLink href="/sobre" className="text-neutral-400">
              Sobre Nós
            </HeaderLink>
          </nav>
            ...
            {!isPending && session ? (
              <>
                <Sheet>
                  ...
                  <SheetContent
                    side="right"
                    className="backdrop--xl z-[150] w-full border-l border-white/10 bg-[#050505]/95 p-0 text-white sm:max-w-[400px]"
                  >
                ...
                <Sheet>
                  ...
                  <SheetContent
                    side="right"
                    className="backdrop--xl z-[150] flex h-full w-full flex-col border-l border-white/10 bg-[#050505]/95 p-0 text-white sm:max-w-[400px]"
                  >
                    <SheetHeader className="border-b border-white/10 p-6">
                      <SheetTitle className="font-clash-display text-xl font-medium text-white">
                        Meu Carrinho
                ...
                <Sheet>
                  ...
                  <SheetContent
                    side="right"
                    className="backdrop--xl z-[150] w-full border-l border-white/10 bg-[#050505]/95 p-0 text-white sm:max-w-[30vw]"
                  >
      ...
      <div className="backdrop--lg relative w-full border-b border-white/10 bg-black/80 px-4 transition-all duration-300 md:px-8">
