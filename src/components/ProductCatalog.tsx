    ...
    <section className="relative z-10 w-full bg-[#010000] px-4 pb-24 md:px-8">
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="flex flex-col text-start">
          <span className="font-montserrat text-sm font-medium tracking-wider text-white uppercase">
            Nosso Catálogo:
          </span>
        </div>
          ...
          <div>
            {categoriesWithProducts.map((catSection) => (
              <div key={catSection.id}>
                ...
                <div className="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-2 sm:gap-6 md:grid-cols-3 lg:grid-cols-5">
